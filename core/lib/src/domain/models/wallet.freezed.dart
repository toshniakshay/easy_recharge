...
mixin _$Wallet {
  ...
  List<TransactionDetails> get transactionHistory =>
...
abstract class $WalletCopyWith<$Res> {
  ...
  @useResult
  $Res call({num accountBalance, List<TransactionDetails> transactionHistory});
}
...
class _$WalletImpl implements _Wallet {
  const _$WalletImpl(
      ...
      final List<TransactionDetails> transactionHistory = const []})
  ...
  final List<TransactionDetails> _transactionHistory;
  @override
  @JsonKey()
  List<TransactionDetails> get transactionHistory {
  ...
  @override
  String toString() {
    return 'Wallet(accountBalance: $accountBalance, transactionHistory: $transactionHistory)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, accountBalance,
...
abstract class _Wallet implements Wallet {
  const factory _Wallet(
      {required final num accountBalance,
      final List<TransactionDetails> transactionHistory}) = _$WalletImpl;
