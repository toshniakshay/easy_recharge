...
abstract class $CurrencyCopyWith<$Res> {
  ...
  @useResult
  $Res call({num amount, String locale});
}
...
class _$CurrencyImpl implements _Currency {
  const _$CurrencyImpl({required this.amount, required this.locale});
  ...
  @override
  String toString() {
    return 'Currency(amount: $amount, locale: $locale)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, amount, locale);
...
abstract class _Currency implements Currency {
  const factory _Currency(
      ...
      required final String locale}) = _$CurrencyImpl;
