...
abstract class $UserCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, Wallet wallet, List<Beneficiary> beneficiaries});
...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, wallet: $wallet, beneficiaries: $beneficiaries)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, wallet,
...
abstract class _User implements User {
  const factory _User(
      ...
      final List<Beneficiary> beneficiaries}) = _$UserImpl;
